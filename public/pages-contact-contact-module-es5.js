...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-contact-contact-module"], {
  ...
  function srcAppPagesContactContactComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ContactComponent = /*#__PURE__*/function () {
      function ContactComponent(formBuilder, contactService, notificationService) {
        ...
        value: function onContactFormSubmit(values) {
          ...
          if (this.contactForm.valid) {
            ...
            this.contactService.createFeedback(contact).subscribe(function (val) {
              _this.notificationService.openSnackBar('Thank you email recieved we will get back to you within 24hrs', 'close');

              setTimeout(function () {
                return _this.formGroupDirective.resetForm();
              }, 0);
            }, function (response) {
              if (_this.contactForm.valid) {
                _this.notificationService.openSnackBar('Error could not saved', 'close');
              }
            }, function () {
    ...
    }), __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _services_contact_service__WEBPACK_IMPORTED_MODULE_3__["ContactService"], src_app_services_notification_service__WEBPACK_IMPORTED_MODULE_4__["NotificationService"]])], ContactComponent);
    /***/
  },
  ...
  function srcAppPagesContactContactModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ContactModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _agm_core__WEBPACK_IMPORTED_MODULE_4__["AgmCoreModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_6__["MatSnackBarModule"]]
    })], ContactModule);
    /***/
  }
}]);
