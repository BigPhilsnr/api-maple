...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-home-home-module"], {
  ...
  function srcAppPagesHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _properties_store_search_property_search_selectors__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../properties/store/search/property.search.selectors */
    "./src/app/pages/properties/store/search/property.search.selectors.ts");
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(appSettings, appService, mediaObserver, store) {
        var _this = this;
        ...
        this.bgImages = ['https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260', 'https://images.pexels.com/photos/1643384/pexels-photo-1643384.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', 'https://images.pexels.com/photos/813692/pexels-photo-813692.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', 'https://images.pexels.com/photos/106399/pexels-photo-106399.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'];
        this.filteredData = {};
        this.settings = this.appSettings.settings; // tslint:disable-next-line: deprecation
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_7__["select"])(_properties_store_search_property_search_selectors__WEBPACK_IMPORTED_MODULE_8__["selectAllPropertySearch"])).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["distinct"])(function (property) {
            return property;
          })).subscribe(function (data) {
            if (_this2.properties && _this2.properties.length > 0) {
              _this2.settings.loadMore.page++;
              _this2.pagination.page = _this2.settings.loadMore.page;
            }

            var result = _this2.filterData(data);

            if (data.length === 0) {
              _this2.properties.length = 0;
              _this2.pagination = new _app_models__WEBPACK_IMPORTED_MODULE_3__["Pagination"](1, _this2.count, null, 2, 0, 0);
              _this2.message = 'No Results Found';
              return false;
            }

            if (_this2.properties && _this2.properties.length > 0) {
              _this2.properties = _this2.properties.concat(result.data);
            } else {
              _this2.properties = result.data;
            }

            _this2.pagination = result.pagination;
            _this2.message = null;

            if (_this2.properties.length == _this2.pagination.total) {
              _this2.settings.loadMore.complete = true;
              _this2.settings.loadMore.result = _this2.properties.length;
            } else {
              _this2.settings.loadMore.complete = false;
            }
          });
          this.loadProperties({
            page: 1,
        ...
        key: "clearChanged",
        value: function clearChanged(event) {
          this.showResult = false;
        }
      }, {
        key: "searchChanged",
    ...
    }), __metadata("design:paramtypes", [_app_settings__WEBPACK_IMPORTED_MODULE_1__["AppSettings"], _app_service__WEBPACK_IMPORTED_MODULE_2__["AppService"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_4__["MediaObserver"], _ngrx_store__WEBPACK_IMPORTED_MODULE_7__["Store"]])], HomeComponent);
    /***/
  },
  ...
  function srcAppPagesHomeHotOfferTodayHotOfferTodayComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HotOfferTodayComponent = /*#__PURE__*/function () {
      function HotOfferTodayComponent(appService, appSettings, sanitizer) {
        _classCallCheck(this, HotOfferTodayComponent);

        this.appService = appService;
        this.appSettings = appSettings;
        this.sanitizer = sanitizer;
        this.bgImages = ['assets/images/props/outside/inside_1.jpg', 'assets/images/props/outside/inside_2.jpg', 'assets/images/props/outside/inside_3.jpg', 'assets/images/props/outside/inside_4.jpg', 'assets/images/props/outside/inside_5.jpg', 'assets/images/props/outside/outside_6.jpg', 'assets/images/props/outside/outside_7.jpg'];
      }
      ...
      _createClass(HotOfferTodayComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.appService.getPropertyById(this.propertyId).subscribe(function (property) {
            ...
            property.desc = '';
            property.gallery.map(function (item, index) {
              item.medium = _this6.bgImages[index];
            });
    ...
    }), __metadata("design:paramtypes", [src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"], src_app_app_settings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"]])], HotOfferTodayComponent);
    /***/
  }
}]);
