...
/* harmony import */ var _register_services_auth_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../register/services/auth.service */ "./src/app/pages/register/services/auth.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(fb, router, store, snackBar, auth) {
        this.fb = fb;
        this.router = router;
        this.store = store;
    ...
    ngOnInit() {
        ...
        this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_register_store_user_selectors__WEBPACK_IMPORTED_MODULE_4__["selectUserToken"])).subscribe(token => this.checkUsers(null, token));
        this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_register_store_user_selectors__WEBPACK_IMPORTED_MODULE_4__["selectCurrentUser"])).subscribe(user => this.checkUsers(user, null));
        this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_register_store_user_selectors__WEBPACK_IMPORTED_MODULE_4__["selectUserError"])).subscribe(error => this.handleError(error));
    }
    handleError(error) {
        if (error.length > 0) {
