...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-register-register-module"], {
  ...
  function srcAppPagesRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _store_user_selectors__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(fb, router, snackBar, store, auth) {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["select"])(_store_user_selectors__WEBPACK_IMPORTED_MODULE_7__["selectCurrentUser"])).subscribe(function (user) {
            return _this.checkUsers(user);
          });
        }
      }, {
        key: "checkUsers",
        value: function checkUsers(user) {
          if (user) {
        ...
        value: function onRegisterFormSubmit(values) {
          if (true) {
            ...
            this.snackBar.open('Registering user', '×', {
              panelClass: 'success',
    ...
    }), __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"], _ngrx_store__WEBPACK_IMPORTED_MODULE_5__["Store"], _services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"]])], RegisterComponent);
    /***/
  },
  ...
  function srcAppPagesRegisterRegisterModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/pages/register/services/user.service.ts");
